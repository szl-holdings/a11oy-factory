...
test("the source checkout carries no hidden workspace auth override", () => {
...
test("the wrapped command preserves the safe default when no app env is present", async () => {
